...
function DialogChangePasswordContent({
  ...
  return (
    <DialogChangePasswordPortal data-slot="dialog-portal">
      ...
      >
        {children}
        <DialogPrimitive.Close className="ring-offset ring-foreground data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 opacity-70 ring-offset-2 outline-hidden transition-opacity hover:opacity-100 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
